...
public class MypageController {
    ...
    public ResponseDto getProfile() {
        ProfileResponse profile = mypageService.getProfile();
        if (profile != null) {
     ...
     */
    @PutMapping
    public ResponseDto updateProfile(@RequestBody ProfileUpdateRequest updateRequest) {
        boolean isUpdated = mypageService.updateProfile(updateRequest);
        if (isUpdated) {
    ...
    public ResponseDto deleteProfile() {
        boolean isDeleted = mypageService.deleteProfile();
        if (isDeleted) {
